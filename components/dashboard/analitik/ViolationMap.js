...
export default function ViolationMap({ locations }) {
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="absolute bottom-3 right-3 z-[1001] rounded-xl border border-slate-200 bg-white/95 px-3 py-2 text-xs text-slate-600 shadow-sm backdrop-blur-sm">
