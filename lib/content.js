...
export const pengemudiPage = {
  ...
  noSchedule: {
    title: "Status pengemudi belum bisa dihitung.",
    hint: "Tabel jadwal masih kosong. Tambahkan jadwal di menu Jadwal, lalu status bertugas, berhenti, istirahat, dan tidak aktif akan terisi otomatis.",
  },
};
