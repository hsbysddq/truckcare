...
export const pengemudiPage = {
  title: "Pengemudi",
  subtitle:
    "Status dihitung dari jadwal dan telemetri truk: bertugas, berhenti, istirahat, atau tidak aktif.",
  summary: [
    { key: "total", label: "Total Pengemudi", icon: "users" },
    { key: "bertugas", label: "Bertugas", icon: "navigation", tone: "success" },
    { key: "istirahat", label: "Istirahat", icon: "circle-pause", tone: "neutral" },
    { key: "tidak_aktif", label: "Tidak Aktif", icon: "clock", tone: "neutral" },
  ],
  ...
  noTruckLabel: "Tidak sedang membawa truk",
  noRouteLabel: "Tidak ada jadwal hari ini",
  detailLinkLabel: "Lihat detail",
  emptyMessage: "Tidak ada pengemudi yang cocok.",
};
