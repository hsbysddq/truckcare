...
export const analitikPage = {
  ...
  charts: {
    ...
    speedingByPlate: {
      ...
      subtitle: "Pelanggaran di atas 80 km/jam per plat, diurutkan dari terbanyak.",
      unit: "insiden",
      showAllLabel: "Lihat semua",
      showTopLabel: "Tampilkan 5 teratas",
      topCount: 5,
      insight: "{k} dari {n} armada menyumbang {pct}% total pelanggaran",
    },
    fuel: {
      title: "Konsumsi Solar per Truk",
      subtitle: "Pilih truk di daftar untuk melihat konsumsi mingguannya.",
      unit: "L",
      detailTitle: "Konsumsi mingguan {plate}",
      anomalyBadge: "{n} anomali",
      normalBadge: "Normal",
      insight: "{plate} menunjukkan {n} anomali solar dalam {days} hari terakhir",
