...
import { BATAS_KECEPATAN_KPJ } from "./speed-limit.js";
...
export const ribbonSection = {
  label: "Ditenagai oleh",
  items: [
    "Supabase",
    "Vercel",
    "Next.js",
  ...
  cards: [
    {
      ...
      description:
        "Setiap tuduhan langsung diperiksa dengan bukti data perjalanan truk, lalu Anda diberi tahu otomatis.",
      image: "/mengapa/laporan.webp",
      alt: "Tampilan dashboard Peta dengan posisi armada dan daftar truk terpantau",
    },
    {
      icon: "funnel",
      title: "Laporan palsu tersaring otomatis",
      description:
        "Setiap laporan diuji terhadap rekaman perjalanan sebelum sampai ke Anda. Laporan palsu tersaring otomatis.",
      image: "/mengapa/pengaduan.webp",
      alt: "Tampilan dashboard Pengaduan dengan laporan yang ditolak AI Agent beserta bukti kecepatan",
    },
    {
      icon: "smartphone",
      title: "Tidak Perlu Memantau Dashboard 24 Jam",
      description:
        "Rekap harian dikirim otomatis ke Telegram. Cukup buka ponsel untuk tahu hasilnya.",
      image: "/mengapa/telegram-bot.webp",
      alt: "Bot Telegram Circle T Monitor menampilkan status armada dan tombol rekap",
    },
    {
      icon: "fuel",
      title: "Temukan pola yang tersembunyi",
      description:
        "AI Agent memeriksa pola solar setiap hari dan memberi tahu saat ada kejanggalan.",
      image: "/mengapa/anomali.webp",
      alt: "Grafik konsumsi solar per truk dengan penanda anomali dan estimasi kerugian",
    },
  ],
};
...
export const footer = {
  ...
  bottom: {
    ...
    // Tanpa href: tampil sebagai teks (tidak ada akun resmi yang ditautkan).
    socials: [
      { label: "Instagram" },
      { label: "TikTok" },
      { label: "GitHub" },
...
export const dashboardNav = [
  ...
  { label: "Armada", href: "/dashboard/armada", icon: "truck", subtitle: "Daftar kendaraan, status, dan pengemudi yang bertugas." },
  { label: "Pengemudi", href: "/dashboard/pengemudi", icon: "users", subtitle: "Status tugas dan beban kerja tiap pengemudi." },
  { label: "Jadwal", href: "/dashboard/jadwal", icon: "calendar-days", subtitle: "Bandingkan rencana perjalanan dengan realisasi telematika, lalu tangkap penyimpangannya." },
  { label: "Chat AI", href: "/dashboard/chat", icon: "bot" },
  { label: "Peta", href: "/dashboard/peta", icon: "map", subtitle: "Posisi armada real-time dari telematika kendaraan, diperbarui setiap beberapa detik." },
  { label: "Pengaduan", href: "/dashboard/pengaduan", icon: "clipboard-check", subtitle: "Tinjau dan validasi laporan masyarakat menggunakan analisis AI berbasis data telematika armada." },
  { label: "Analitik", href: "/dashboard/analitik", icon: "chart-column", subtitle: "Ringkasan kerja agent dan temuan operasional armada." },
  { label: "Pengaturan", href: "/dashboard/pengaturan", icon: "settings", subtitle: "Kelola akun, akses bot Telegram, dan perilaku AI agent." },
];
...
export const pengemudiPage = {
  title: "Papan Pengemudi",
  subtitle: "Status tugas dan beban kerja tiap pengemudi.",
  summaryUnit: "pengemudi",
  idLabel: "ID",
  columnEmpty: "Tidak ada",
  viewToggle: {
    groupLabel: "Tampilan",
    boardLabel: "Tampilan papan",
    listLabel: "Tampilan daftar",
  },
  ...
  stats: {
    ...
    tripsMiniLabel: "perjalanan",
    onTimeLabel: "Tepat waktu",
    onTimeMiniLabel: "tepat waktu",
...
export const armadaPage = {
  title: "Daftar Armada",
  subtitle: "Daftar kendaraan, status, dan pengemudi yang bertugas.",
  countBadgeSuffix: "Kendaraan",
  // Filter pill: status (truckStatusMeta) dan jenis armada (lib/truck-types.js).
  filters: {
    statusLabel: "Status",
    typeLabel: "Jenis",
    allLabel: "Semua",
    emptyMessage: "Tidak ada truk yang cocok dengan filter.",
  },
...
export const truckDetailPage = {
  ...
  aiButtonLabel: "Tanya AI",
  speedLimitKph: BATAS_KECEPATAN_KPJ,
  map: {
...
export const pengaduanManagementPage = {
  ...
  filters: [
    ...
    // Laporan luar_armada tidak punya tombol filter sendiri: tetap tampil di
    // "Semua" dengan badge "Bukan Armada Kami" (complaintStatusMeta).
  ...
  agentBox: {
    ...
    analyzingLabel: "Sedang dianalisis...",
    failedLabel: "Analisis gagal",
    reanalyzeLabel: "Analisis ulang",
    reanalyzingLabel: "Menganalisis...",
    analyzedAtPrefix: "Dianalisis",
    verdictLabels: {
      terbukti: "Terbukti",
      tidak_terbukti: "Tidak terbukti",
      sedang_diperiksa: "Sedang diperiksa",
      luar_armada: "Bukan armada kami",
    },
  },
  ...
  decisionBoxes: {
    operator: {
      title: "Diputuskan oleh Tim Internal",
      description: "Keputusan ini dibuat oleh tim, bukan sistem otomatis.",
      byLabel: "Diputuskan oleh",
      afterAgentNote: "Keputusan akhir diambil tim setelah melihat analisis agent di atas.",
    },
    sistem: {
  ...
  vehicleInfo: {
    ...
    typeLabel: "Tipe Armada",
    driverLabel: "Pengemudi",
    driverUncertain: "Tidak dapat dipastikan, tidak ada jadwal yang cocok",
    notAnalyzed: "Belum dianalisis",
  },
  telemetryInfo: {
  ...
  // STATE B (sudah diputuskan): blok keputusan jadi header panel.
  decisionHeader: {
    labels: { tervalidasi: "Divalidasi", ditolak: "Ditolak" },
    reasonsTitle: "Alasan keputusan",
    noReasons: "Alasan keputusan belum tercatat.",
  },
  originalReport: {
    label: "Laporan asli",
...
export const chatPage = {
  ...
  // Saran cepat saat konteks truk aktif: selalu menyertakan plat supaya
  // backend memperlakukan pertanyaan sebagai satu truk, bukan seluruh armada.
  truckQuickSuggestions: [
    "Rangkum kondisi {plate} hari ini",
    "Rekap perjalanan {plate} hari ini",
    "Di mana posisi {plate} sekarang?",
    "Apa status truk {plate} sekarang?",
  ],
  fallbackReply:
  ...
  errors: {
    ...
    clear: "Gagal menghapus riwayat percakapan. Coba lagi.",
    retryLabel: "Coba lagi",
    dismissLabel: "Tutup",
  },
  clearHistoryLabel: "Hapus riwayat",
  clearHistoryConfirm: "Ketuk sekali lagi untuk menghapus semua riwayat",
...
export const analitikPage = {
  ...
  // Spanduk di atas kartu metrik saat rentang yang dipilih tidak punya data
  // sama sekali (bukan angka nol yang terlihat seperti sistem rusak).
  rangeEmpty: {
    title: "Belum ada data pada {days} hari terakhir",
    hint: "Pengaduan, insiden ngebut, dan validasi tidak tercatat pada rentang ini. Coba rentang lain:",
    hintNoData: "Belum ada data pada rentang mana pun. Pastikan simulasi/seed data sudah berjalan.",
  },
  ...
  charts: {
    ...
    speedingByPlate: {
      ...
      subtitle:
        `Pelanggaran di atas ${BATAS_KECEPATAN_KPJ} km/jam per plat beserta jenis truknya, diurutkan dari terbanyak. Batang oranye adalah penyumbang terbanyak.`,
      unit: "insiden",
      topLabel: "Penyumbang terbanyak",
      emptyTitle: "Tidak ada pelanggaran kecepatan tercatat pada periode ini",
      emptyHint: "Coba rentang waktu yang lebih panjang atau pilih armada lain.",
...
export const pengaturanPage = {
  title: "Pengaturan",
  subtitle: "Kelola akun, akses bot Telegram, dan perilaku AI agent.",
  sections: {
    akun: {
      title: "Pengaturan Akun",
      description: "Akun yang sedang masuk untuk membuka dashboard.",
    },
    telegram: {
      title: "Bot Telegram",
      description:
        "Kelola akses chat bot dan pantau koneksi untuk rekap serta notifikasi.",
    },
    ai: {
      title: "AI Agent",
      description: "Koneksi ke OpenClaw dan aturan perilaku (system prompt).",
    },
  },
  accountCard: {
    title: "Akun",
