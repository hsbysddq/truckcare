...
const trucks = [
  ...
  },
  {
    ...
    origin: "Gresik",
    destination: "Kawasan Industri Manyar",
    progressPct: 60,
    tripStatus: "jalan",
  },
  {
    ...
    tripHistory: [
      {
        time: "06:45",
        title: "Berangkat dari Pelabuhan Gresik",
        description: "Mengangkut material industri ke Manyar.",
      },
      {
        time: "07:30",
      ...
      {
        time: "08:00",
        title: "Mendekati Kawasan Industri Manyar",
...
export function getChatHistory() {
  return [
    ...
    },
    {
      id: "msg-2",
      role: "agent",
      text: "Saat ini ada 10 truk yang dipantau. 6 unit aktif bergerak, 2 sedang istirahat, dan 2 mengalami insiden yang perlu perhatian segera.",
      toolTrace: {
      ...
      dataCard: {
        ...
        rows: [
          { label: "Total Armada", value: "10 Unit" },
          { label: "Aktif Bergerak", value: "6 Unit" },
          { label: "Sedang Istirahat", value: "2 Unit" },
          {
            label: "Insiden",
            value: "2 Unit",
    ...
    },
    {
      id: "msg-4",
      role: "agent",
      text: "Ada 2 laporan berstatus pending yang menunggu validasi Anda, yaitu #RPT-082 dan #RPT-081. Keduanya punya tingkat keyakinan AI yang tinggi.",
      toolTrace: {
...
export function getAgentActivity() {
  return [
    ...
    },
    {
      time: "09:15",
      trigger: "otomatis",
      description: "Anomali solar terdeteksi pada L 4405 QR",
