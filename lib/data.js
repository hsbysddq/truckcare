...
const complaints = [
  ...
  },
  {
    ...
    agentConfidence: "tinggi",
    agentReasoning:
      `Telemetri mengonfirmasi kecepatan tercatat 115 km/jam, ${115 - BATAS_KECEPATAN_KPJ} km/jam di atas batas kecepatan tol ${BATAS_KECEPATAN_KPJ} km/jam. Titik GPS dan waktu kejadian cocok persis dengan lokasi dan jam yang dilaporkan pelapor.`,
    agentFindings: [
      `Plat cocok: ${P(5)}`,
    ...
    recordedSpeed: 115,
    speedLimit: BATAS_KECEPATAN_KPJ,
  ...
  },
  {
    ...
    agentReasoning:
      `Telemetri mencatat kecepatan puncak 84 km/jam, hanya ${84 - BATAS_KECEPATAN_KPJ} km/jam di atas batas ${BATAS_KECEPATAN_KPJ} km/jam. Selisihnya tergolong kecil dan masih dalam rentang wajar arus lalu lintas, sehingga agent tidak memutuskan sendiri dan memerlukan peninjauan manusia.`,
    agentFindings: [
      `Plat cocok: ${P(4)}`,
    ...
    plates.forEach((plate, pi) => {
      ...
      for (let k = 0; k < n; k += 1) {
        ...
        speedingEvents.push({
          ...
          hour,
          plateNumber: plate,
          speedKph: BATAS_KECEPATAN_KPJ + 1 + Math.round(pseudoRandom(seed * 9.1 + pi + k) * 40),
