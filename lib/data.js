...
const TRUCKS_RAW = [
  ...
  // ---- Truk 11-20: 7 CDD, 2 Fuso, 1 Trailer (total 20: 10 CDD, 7 Fuso, 3 Trailer) ----
  {
    id: "trk-11", plateNumber: "L 2210 BC", model: "Mitsubishi Colt Diesel FE 74 HD", type: "cdd",
    driverName: "Kurniawan Adi", status: "bergerak", lat: TITIK.gresik.lat, lng: TITIK.gresik.lng,
    speedKph: 41, fuelLevelPct: 58, odometerKm: 74210, lastUpdate: "4 menit lalu",
    origin: "Gresik", destination: "Surabaya", progressPct: 30, tripStatus: "jalan",
  },
  {
    id: "trk-12", plateNumber: "W 7781 DE", model: "Isuzu Elf NMR 71", type: "cdd",
    driverName: "Lukman Hakim", status: "istirahat", lat: TITIK.sidoarjo.lat, lng: TITIK.sidoarjo.lng,
    speedKph: 0, fuelLevelPct: 71, odometerKm: 58930, lastUpdate: "26 menit lalu",
    origin: "Sidoarjo", destination: "Krian", progressPct: 0, tripStatus: "berhenti",
  },
  {
    id: "trk-13", plateNumber: "N 3315 FG", model: "Mitsubishi Fuso Fighter FN 62", type: "fuso",
    driverName: "Made Wirawan", status: "bergerak", lat: TITIK.lawang.lat, lng: TITIK.lawang.lng,
    speedKph: 47, fuelLevelPct: 63, odometerKm: 131400, lastUpdate: "2 menit lalu",
    origin: "Surabaya", destination: "Malang", progressPct: 70, tripStatus: "jalan",
  },
  {
    id: "trk-14", plateNumber: "AG 1290 HJ", model: "Hino Dutro 130 MDL", type: "cdd",
    driverName: "Nanang Firmansyah", status: "bergerak", lat: TITIK.pare.lat, lng: TITIK.pare.lng,
    speedKph: 38, fuelLevelPct: 49, odometerKm: 91750, lastUpdate: "6 menit lalu",
    origin: "Kediri", destination: "Malang", progressPct: 20, tripStatus: "jalan",
  },
  {
    id: "trk-15", plateNumber: "L 6634 KM", model: "Scania R410 Trailer", type: "trailer",
    driverName: "Oka Pratama", status: "bergerak", lat: TITIK.tanjungPerak.lat, lng: TITIK.tanjungPerak.lng,
    speedKph: 22, fuelLevelPct: 77, odometerKm: 233800, lastUpdate: "1 menit lalu",
    origin: "Surabaya", destination: "Gresik", progressPct: 10, tripStatus: "jalan",
  },
  {
    id: "trk-16", plateNumber: "W 4102 NP", model: "Mitsubishi Colt Diesel FE 74 HD", type: "cdd",
    driverName: "Putra Mahendra", status: "istirahat", lat: TITIK.krian.lat, lng: TITIK.krian.lng,
    speedKph: 0, fuelLevelPct: 84, odometerKm: 46220, lastUpdate: "41 menit lalu",
    origin: "Sidoarjo", destination: "Krian", progressPct: 100, tripStatus: "berhenti",
  },
  {
    id: "trk-17", plateNumber: "N 8857 QS", model: "Isuzu Elf NMR 71", type: "cdd",
    driverName: "Rizky Hidayat", status: "bergerak", lat: TITIK.purwosari.lat, lng: TITIK.purwosari.lng,
    speedKph: 44, fuelLevelPct: 55, odometerKm: 68390, lastUpdate: "3 menit lalu",
    origin: "Pasuruan", destination: "Malang", progressPct: 45, tripStatus: "jalan",
  },
  {
    id: "trk-18", plateNumber: "L 1478 TU", model: "Hino Ranger FM 260", type: "fuso",
    driverName: "Slamet Riyadi", status: "istirahat", lat: TITIK.margomulyo.lat, lng: TITIK.margomulyo.lng,
    speedKph: 0, fuelLevelPct: 36, odometerKm: 176540, lastUpdate: "15 menit lalu",
    origin: "Surabaya", destination: "Pasuruan", progressPct: 0, tripStatus: "berhenti",
  },
  {
    id: "trk-19", plateNumber: "W 9925 VX", model: "Hino Dutro 130 MDL", type: "cdd",
    driverName: "Taufik Hidayat", status: "bergerak", lat: TITIK.gempol.lat, lng: TITIK.gempol.lng,
    speedKph: 51, fuelLevelPct: 62, odometerKm: 83110, lastUpdate: "Baru saja",
    origin: "Sidoarjo", destination: "Pasuruan", progressPct: 55, tripStatus: "jalan",
  },
  {
    id: "trk-20", plateNumber: "AG 7013 YZ", model: "Mitsubishi Colt Diesel FE 74 HD", type: "cdd",
    driverName: "Umar Hadi", status: "insiden", lat: TITIK.kandangan.lat, lng: TITIK.kandangan.lng,
    speedKph: 0, fuelLevelPct: 27, odometerKm: 102670, lastUpdate: "52 menit lalu",
    origin: "Kediri", destination: "Malang", progressPct: 40, tripStatus: "terlambat",
  },
];
...
// Semua contoh di atas dianalisis agent (punya reasoning + keyakinan).
  ...
  driverId: getDrivers().find((d) => d.name === complaint.driverName)?.id ?? null,
...
export function getAnalyticsSource() {
  ...
  const fuelDaily = plates.map((plate) => {
    const truck = trucks.find((t) => t.plateNumber === plate);
