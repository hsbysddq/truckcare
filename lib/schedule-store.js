...
const SELECT =
  "?select=id,truck_id,driver_id,origin,destination,planned_departure,planned_arrival,actual_departure,actual_arrival,status,cargo_type,notes,created_at,trucks(plat,tipe),drivers(nama)";
